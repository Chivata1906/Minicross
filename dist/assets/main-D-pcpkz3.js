import"./main-Cn0lQ1oV.js";import{r as s,i}from"./navbar-7W85b2i_.js";function o(){const e=document.getElementById("app");e&&(e.innerHTML=`
    ${s("home")}
    ...
    <section class="py-16 dirt-texture">
      <div class="mx-auto max-w-7xl px-4">
        ...
        <div class="grid gap-4 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
          ${[["50cc A","4 – 6 años"],["50cc B","6 – 8 años"],["65cc A","7 – 9 años"],["65cc B","8 – 10 años"],["85cc A","9 – 11 años"],["85cc B","11 – 13 años"],["125cc Junior","12 – 17 años"]].map(([t,a])=>`
            <div class="card flex items-center gap-4">
              <span class="font-title text-3xl text-secondary">${t}</span>
              <span class="text-gray-light font-medium">${a}</span>
            </div>`).join("")}
        </div>
      </div>
    </section>
